...
|------------|----------------|
| H1 — Image médiatique | ⚠️ Partiellement confirmée |
| H2 — Sujets dominants | ⚠️ Partiellement confirmée |
| H3 — Impact du nord | ⚠️ Asymétrie confirmée — causalité non établie |
| H4 — Signaux faibles | ⏳ Non testée dans l'EDA (pics détectés, pas précurseurs) |
| H5 — Moments marquants | ⚠️ Partiellement confirmée |
